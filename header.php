...
if (!empty($_SESSION['user_id'])) {
    ...
    $res = mysqli_query($conn, "SELECT username FROM users WHERE id = {$uid} LIMIT 1");
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <ul class="navbar-nav ms-auto align-items-center">
        <?php if ($userName): ?>
          <li class="nav-item"><span class="nav-link">Hi, <?= htmlspecialchars($userName, ENT_QUOTES) ?></span></li>
